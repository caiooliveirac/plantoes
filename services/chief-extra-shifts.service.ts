 ...
 * não existe.
 *
 * Persistência: uma linha em admin_extra_shifts com kind 'chief' e unit +1.
 */
...
export async function loadChiefExtraShifts(
    ...
    const rows = await getDb()
        ...
        .where(and(
            ...
            eq(adminExtraShifts.kind, CHIEF_EXTRA_SHIFT_KIND),
...
/** Cria o plantão de chefia. Um por dia+turno — duplo clique cai no erro. */
...
/** Troca dia/turno de um plantão de chefia declarado no mês corrente. */
